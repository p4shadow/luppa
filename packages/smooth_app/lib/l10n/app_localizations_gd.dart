...
class AppLocalizationsGd extends AppLocalizations {
  ...
  @override
  String get product_search_same_category => 'Lorg roghainnean eile';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Diùlt am moladh';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Leig leis a’ choimhearsnachd prìsean a chaidh a tharraing a-mach le AI a dhearbhadh.';
  ...
  String get prices_bulk_proof_upload_step_selecting =>
      'A’ taghadh fhaidhlichean';

  @override
  String get prices_bulk_proof_upload_step_starting =>
      'A’ tòiseachadh air an luchdachadh suas';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'A’ dèanamh lethbhreac ionadail den fhaidhle #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'A’ cur deiseil airson luchdachadh suas #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Dh’fhàillig aig an ìomhaigh #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'Nì gun chòd-barra';

  @override
  String get prices_per_kilogram => 'Prìs gach cileagram';
  ...
  @override
  String get prices_per_unit_short => ' / aonad';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Roghainneil';

  @override
  String get prices_category_error_mandatory =>
      'Tha an roinn-seòrsa èigneachail';
  ...
  @override
  String get prices_list_title => 'Liosta prìsean';

  @override
  String get prices_list_count => 'Àireamh de phrìsean\n';
  ...
  @override
  String get prices_entry_menu_my_prices => 'Seall na prìsean eile agam';

  @override
  String get prices_entry_menu_author_prices =>
      'Seall prìsean eile leis an ùghdar';

  @override
  String get prices_entry_menu_shop_prices => 'Seall prìsean eile bhon bhùth';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Prìs air a chur ris roimhe';
  ...
  String user_any_search_prices_title(String user) {
    return 'Prìsean luchd-tabhartais: $user';
  }
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Atharraich a’ chànan bunaiteach?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'A bheil thu airson gum bi cànan bunaiteach an toraidh air a shuidheachadh gu \'$language\'?';
  }
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Diùlt am moladh';

  @override
  String get product_edit_robotoff_show_proof => 'Seall fianais';

  @override
  String get product_edit_robotoff_expand_proof => 'Leudaich dearbhadh';

  @override
  String get product_page_tab_raw_data => 'Dàta amh';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Duilleag $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Duilleag $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count de $total nithean';
  }
  ...
  @override
  String get prices_no_result => 'Cha deach staitistig prìsean a lorg.';

  @override
  String get prices_error_loading_more_items =>
      'Mearachd le bhith a’ luchdachadh barrachd nithean';
