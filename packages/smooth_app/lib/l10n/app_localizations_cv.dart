...
class AppLocalizationsCv extends AppLocalizations {
  ...
  @override
  String get product_search_same_category => 'Альтернативӑсем тупӑр';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Сӗнӗве йышӑнмасӑр';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Сообществӑна ИИ кӑларнӑ хаксене тӗрӗслеме ирӗк парӑр.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Файлсене суйласа илни';

  @override
  String get prices_bulk_proof_upload_step_starting =>
      'Ҫӳлелле ҫӗклеме пуҫлани';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Вырӑнта копилекен файл #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return '#$index/$countярса пама хатӗрленетпӗр';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return '#$index/$countӳкерчӗкре ӑнӑҫсӑр пулнӑ';
  }
  ...
  @override
  String get prices_category_enter => 'Штрих-кодсӑр япала';

  @override
  String get prices_per_kilogram => 'Пӗр килограмм хакӗ';
  ...
  @override
  String get prices_per_unit_short => ' / пӗрре';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Опци';

  @override
  String get prices_category_error_mandatory => 'Категори обязательная';
  ...
  @override
  String get prices_entry_menu_my_prices => 'Манӑн ытти хаксене пӑхӑр';

  @override
  String get prices_entry_menu_author_prices => 'Авторӑн ытти хакӗсене пӑхӑр';

  @override
  String get prices_entry_menu_shop_prices => 'Ытти хаксене лавккаран пӑхӑр';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Хакне малтан хушнӑ';
  ...
  String user_any_search_prices_title(String user) {
    return 'Ҫыхӑну паракансен хакӗсем: $user';
  }
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Стандартлӑ чӗлхене улӑштармалла-и?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Эсир продуктӑн стандартлӑ чӗлхине \'$language\' лартасшӑн-и?';
  }
  ...
  @override
  String get product_page_tab_for_me => 'Маншӑн';
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Сӗнӗве сирсе ярӑр';

  @override
  String get product_edit_robotoff_show_proof => 'Ҫирӗплетӳ кӑтарт';

  @override
  String get product_edit_robotoff_expand_proof => 'Доказательствӑна анлӑлат';

  @override
  String get product_page_tab_raw_data => 'Чӗрӗ даннӑйсем';
  ...
  String item_count_with_total(int count, int total) {
    return '$count $total япаласенчен';
  }
  ...
  @override
  String get prices_no_result => 'Хаксен статистики тупӑнман.';

  @override
  String get prices_error_loading_more_items =>
      'Ытларах япаласем илсе килнӗ чухне йӑнӑш';
