...
class AppLocalizationsKy extends AppLocalizations {
  ...
  @override
  String get contribute_donate_title => 'Колдоо';
  ...
  @override
  String get ranking_tab_all => 'Баары';
  ...
  @override
  String get scan_navbar_label => 'Скандоо';
  ...
  @override
  String get nutrition => 'Тамактануу';
  ...
  @override
  String get new_product_found_button => 'Бул өнүмдү кошуу';
  ...
  @override
  String get nutrition_page_add_nutrient => 'Аш болумдуу зат кошуңуз';
  ...
  @override
  String get product_search_same_category => 'Альтернативаларды табыңыз';
  ...
  @override
  String get retry_button_label => 'Кайталоо';
  ...
  @override
  String get user_profile_title_guest => 'Кош келиңиз!';
  ...
  @override
  String get edit_product_label_short => 'Оңдоо';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Сунуштан баш тартуу';
  ...
  @override
  String get edit_product_form_item_photos_title => 'Сүрөттөр';
  ...
  @override
  String get edit_product_form_item_labels_type => 'белгилөө';
  ...
  @override
  String get edit_product_form_item_origins_type => 'мамлекет';
  ...
  @override
  String get edit_product_form_item_countries_type => 'мамлекет';
  ...
  @override
  String get edit_product_form_item_add_valid_item_tooltip => 'Кошуу';
  ...
  @override
  String get edit_product_form_save => 'Оңдоо';
  ...
  @override
  String get user_list_title => 'Сиздин тизмелериңиз';
  ...
  @override
  String get category_picker_no_category_found_button => 'Артка';
  ...
  @override
  String get dev_preferences_button_positive => 'Макул';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Коомчулукка AI тарабынан алынган бааларды текшерүүгө уруксат бериңиз.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Файлдарды тандоо';

  @override
  String get prices_bulk_proof_upload_step_starting =>
      'Жүктөп берүү башталууда';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Файлды жергиликтүү көчүрүү #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Жүктөп берүү даярдалууда #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Сүрөттө ишке ашкан жок #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'Штрихкоду жок нерсе';

  @override
  String get prices_per_kilogram => 'Баасы килограммына';
  ...
  @override
  String get prices_per_unit_short => ' / бирдик';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Кошумча';

  @override
  String get prices_category_error_mandatory =>
      'категория милдеттүү болуп саналат';
  ...
  @override
  String get prices_list_title => 'Баа тизмеси';
  ...
  @override
  String get prices_entry_shop_not_found => 'Белгисиз дүкөн';
  ...
  @override
  String get prices_entry_menu_open_proof => 'Далил көрүү';

  @override
  String get prices_entry_menu_my_prices => 'Менин башка бааларды караңыз';

  @override
  String get prices_entry_menu_author_prices => 'Автордун башка баасын көрүү';

  @override
  String get prices_entry_menu_shop_prices => 'Дүкөндөн башка бааларды караңыз';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Баасы мурда кошулган';
  ...
  String user_any_search_prices_title(String user) {
    return 'Салымчылардын баасы: $user';
  }
  ...
  @override
  String get edit_photo_button_label => 'Оңдоо';
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Демейки тил өзгөртүлсүнбү?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Өнүмдүн демейки тили \'$language\' болуп коюлушун каалайсызбы?';
  }
  ...
  @override
  String get action_delete_list => 'Өчүрүү';

  @override
  String get action_change_list => 'Change the current list';

  @override
  String get product_list_create => 'Түзүү';
  ...
  @override
  String get carousel_error_button => 'Кайталоо';
  ...
  @override
  String get carousel_unknown_product_button => 'Бул өнүмдү кошуу';
  ...
  @override
  String get prices_stats_countries => 'Өлкөлөр';
  ...
  @override
  String get product_edit_robotoff_positive_button => 'Сунушту кабыл алыңыз';

  @override
  String get product_edit_robotoff_negative_button => 'Сунуштан баш тартуу';

  @override
  String get product_edit_robotoff_show_proof => 'Далил көрсөт';

  @override
  String get product_edit_robotoff_expand_proof => 'Далилди кеңейтүү';

  @override
  String get product_page_tab_raw_data => 'Чийки маалыматтар';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Барак $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Барак $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$total нерселердин $count';
  }
  ...
  @override
  String get prices_no_result => 'Эч кандай баа статистикасы табылган жок.';

  @override
  String get prices_error_loading_more_items =>
      'Көбүрөөк нерселерди жүктөө катасы';
