...
class AppLocalizationsTs extends AppLocalizations {
  ...
  String get product_search_same_category =>
      'Kuma swin’wana leswi u nga swi endlaka';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Ala xiringanyeto';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Pfumelela vaaki ku tiyisisa minxavo leyi humesiweke hi AI.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Ku hlawula tifayela';

  @override
  String get prices_bulk_proof_upload_step_starting => 'Ku sungula ku upload';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Ku kopa fayili ya laha kaya #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Ku lunghiselela ku upload #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Ku tsandzekile eka xifaniso #$index/$count';
  }
  ...
  @override
  String get prices_list_title => 'Nxaxamelo wa minxavo';

  @override
  String get prices_list_count => 'Nhlayo ya\nminxavo';
  ...
  String prices_entry_menu_title(String user) {
    return 'Ku nghena ka nxavo ku suka eka \"$user\".';
  }
  ...
  @override
  String get prices_entry_menu_my_prices => 'Languta minxavo ya mina yin’wana';

  @override
  String get prices_entry_menu_author_prices =>
      'Languta minxavo yin’wana hi mutsari';

  @override
  String get prices_entry_menu_shop_prices =>
      'Languta minxavo yin’wana ku suka exitolo';
  ...
  String user_any_search_prices_title(String user) {
    return 'Minxavo ya vahoxi va xandla: $user';
  }
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Cinca ririmi ra ntolovelo?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Xana u lava leswaku ririmi ra xiviri ra xiendliwa ri vekiwa eka \'$language\'?';
  }
  ...
  @override
  String get product_page_tab_for_me => 'Eka mina';
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Ala xiringanyeto';

  @override
  String get product_edit_robotoff_show_proof => 'Kombisa vumbhoni';

  @override
  String get product_edit_robotoff_expand_proof => 'Ku ndlandlamuxa vumbhoni';

  @override
  String get product_page_tab_raw_data => 'Data ya raw';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Tluka $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Tluka $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count ya $total swilo';
  }
  ...
  @override
  String get prices_no_result => 'Ku hava tinhlayo ta nxavo leti kumiweke.';

  @override
  String get prices_error_loading_more_items =>
      'Xihoxo xa ku layicha swilo swo tala';
