...
class AppLocalizationsTg extends AppLocalizations {
  ...
  @override
  String get product_search_same_category => 'Алтернативаҳоро пайдо кунед';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Пешниҳодро рад кунед';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Ба ҷомеа иҷозат диҳед, ки нархҳои аз ҷониби AI истихроҷшударо тасдиқ кунанд.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Интихоби файлҳо';

  @override
  String get prices_bulk_proof_upload_step_starting => 'Оғози боргузорӣ';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Файли ба таври маҳаллӣ нусхабардорӣ #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Омода кардани боргузорӣ #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Муваффақият дар тасвир #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'Маҳсулот бе штрих-код';

  @override
  String get prices_per_kilogram => 'Нархи як килограмм';
  ...
  @override
  String get prices_per_unit_short => ' / воҳиди';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Ихтиёрӣ';

  @override
  String get prices_category_error_mandatory => 'Категория ҳатмӣ аст';
  ...
  @override
  String get prices_list_title => 'Рӯйхати нархҳо';

  @override
  String get prices_list_count => 'Шумораи\nнархҳо';
  ...
  @override
  String get prices_entry_menu_my_prices => 'Дигар нархҳои маро бубинед';

  @override
  String get prices_entry_menu_author_prices =>
      'Дигар нархҳоро аз ҷониби муаллиф дидан кунед';

  @override
  String get prices_entry_menu_shop_prices =>
      'Дигар нархҳоро аз мағоза дидан кунед';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Нархи қаблан иловашуда';
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Забони пешфарзро тағир диҳед?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Оё шумо мехоҳед, ки забони пешфарзии маҳсулот ба \'$language\' таъин карда шавад?';
  }
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Пешниҳодро рад кунед';

  @override
  String get product_edit_robotoff_show_proof => 'Далел нишон диҳед';

  @override
  String get product_edit_robotoff_expand_proof => 'Исботро васеъ кунед';

  @override
  String get product_page_tab_raw_data => 'Маълумоти хом';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Саҳифа $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Саҳифа $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count аз $total ашё';
  }
  ...
  @override
  String get prices_no_result => 'Ягон омори нарх ёфт нашуд.';

  @override
  String get prices_error_loading_more_items =>
      'Хатогӣ ҳангоми боркунии ҷузъҳои бештар';
