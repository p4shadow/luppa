...
class AppLocalizationsTw extends AppLocalizations {
  ...
  String get product_search_same_category =>
      'Hwehwɛ akwan foforo a wobɛfa so ayɛ saa';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Ma mpɔtam hɔfo kwan ma wɔmfa nneɛma bo a AI yi fi mu no nyɛ nokware.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Fael ahorow a wɔpaw';

  @override
  String get prices_bulk_proof_upload_step_starting =>
      'Wofi ase de upload no to hɔ';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Fael a wɔrekopi wɔ mpɔtam hɔ #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Woresiesie upload #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Di nkogu wɔ mfonini #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'Ade a enni barcode';

  @override
  String get prices_per_kilogram => 'Kilo biara bo';
  ...
  @override
  String get prices_per_unit_short => ' / ɔfa';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Ɛnyɛ ɔhyɛ';

  @override
  String get prices_category_error_mandatory => 'Ɔfã no yɛ ahyɛde';
  ...
  @override
  String get prices_list_title => 'Nneɛma bo a wɔahyehyɛ';

  @override
  String get prices_list_count => 'Dodow a\nbo yɛ';
  ...
  @override
  String get prices_entry_menu_my_prices => 'Hwɛ me bo afoforo';

  @override
  String get prices_entry_menu_author_prices =>
      'Hwɛ bo afoforo a ɔkyerɛwfo no de mae';

  @override
  String get prices_entry_menu_shop_prices =>
      'Hwɛ nneɛma bo afoforo fi sotɔɔ no mu';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Price a wɔadi kan de aka ho';
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Sesa kasa a wɔde di dwuma dedaw no?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Wopɛ sɛ wɔde afiri no kasa a wɔde ahyɛ mu no si \'$language\'?';
  }
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Pow nyansahyɛ ahorow';

  @override
  String get product_edit_robotoff_show_proof => 'Kyerɛ adanse';

  @override
  String get product_edit_robotoff_expand_proof => 'Trɛw adanse mu';

  @override
  String get product_page_tab_raw_data => 'Data a wɔanhyehyɛ no yiye';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Kratafa $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Kratafa $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count a $total nneɛma';
  }
  ...
  @override
  String get prices_no_result => 'Wonhuu bo ho akontaabu biara.';

  @override
  String get prices_error_loading_more_items =>
      'Mfomso a ɛba bere a wɔde nneɛma pii rehyɛ mu';
