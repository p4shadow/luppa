...
>>>>>>> 33fe57b5c (Primer commit)
  ...
  @override
  String get product_search_same_category => 'געפֿינען אַלטערנאַטיוון';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'אָפּזאָגן פֿאָרשלאָג';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'דערלויבט דער קהילה צו וואַלידירן פרייזן עקסטראַקטעד דורך קינסטלעכער אינטעליגענץ.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'אויסקלייבן טעקעס';

  @override
  String get prices_bulk_proof_upload_step_starting => 'אָנהייבן דעם אַפּלאָוד';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'לאקאל קאפירן טעקע #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'צוגרייטן אַפּלאָוד #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'דורכגעפאלן ביי בילד #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'אַרטיקל אָן באַרקאָד';

  @override
  String get prices_per_kilogram => 'פרייז פּער קילאָגראַם';
  ...
  @override
  String get prices_per_unit_short => ' / איינהייט';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'אפציאנאל';

  @override
  String get prices_category_error_mandatory => 'די קאַטעגאָריע איז פארלאנגט';
  ...
  @override
  String get prices_list_title => 'פרייז ליסטע';

  @override
  String get prices_list_count => 'נומער פון\nפרייזן';
  ...
  @override
  String get prices_entry_menu_my_prices => 'זעט מײַנע אַנדערע פּרײַזן';

  @override
  String get prices_entry_menu_author_prices => 'זעה אנדערע פרייזן פונעם מחבר';

  @override
  String get prices_entry_menu_shop_prices => 'זעט אנדערע פרייזן פון די קראָם';
  ...
  @override
  String get prices_amount_existing_subtitle => 'פרייז פריער צוגעגעבן';
  ...
  String user_any_search_prices_title(String user) {
    return 'ביישטייערער פרייזן: $user';
  }
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'טוישן די דיפאָלט שפּראַך?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'ווילסטו אז די פראדוקט\'ס דיפאלט שפראך זאל זיין געשטעלט צו \'$language\'?';
  }
...
>>>>>>> 33fe57b5c (Primer commit)
  ...
  @override
  String get product_edit_robotoff_negative_button => 'אָפּוואַרפן פֿאָרשלאָג';

  @override
  String get product_edit_robotoff_show_proof => 'ווייַזן באַווייַז';

  @override
  String get product_edit_robotoff_expand_proof => 'אויסברייטערן באַווייַז';

  @override
  String get product_page_tab_raw_data => 'רויע דאַטן';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'בלאַט $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'בלאַט $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count פון $total זאכן';
  }
  ...
  @override
  String get prices_no_result => 'קיין פרייז סטאטיסטיק געפונען.';

  @override
  String get prices_error_loading_more_items => 'טעות אין לאָדן מער זאכן';
