...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get sign_up_page_display_name_hint => 'Атауы';
  ...
  @override
  String get sign_up_page_password_hint => 'Құпиясөз';
  ...
  @override
  String get nutrition => 'Тамақтану';
  ...
  @override
  String get take_photo_title => 'Суретке түсіру';
...
>>>>>>> 33fe57b5c (Primer commit)
  ...
  @override
  String get nutrition_page_nutritional_info_value_positive => 'Иә';

  @override
  String get nutrition_page_nutritional_info_value_negative => 'Жоқ';
  ...
  @override
  String get nutrition_page_serving_size => 'Порция мөлшері';
  ...
  @override
  String get product_image_action_take_picture => 'Суретке түсіру';
  ...
  @override
  String get app_review_negative_modal_negative_button => 'Жоқ';
  ...
  @override
  String get product_search_same_category => 'Баламаларды табыңыз';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Ұсынысты қабылдамау';
  ...
  @override
  String get edit_product_form_item_stores_title => 'Дүкендер';

  @override
  String get edit_product_form_item_stores_hint => 'Input a store';

  @override
  String get edit_product_form_item_stores_type => 'дүкен';
  ...
  @override
  String get edit_product_form_item_traces_title => 'Қамтуы мүмкін';
  ...
  @override
  String get edit_product_form_item_categories_title => 'Санаттар';

  @override
  String get edit_product_form_item_categories_hint => 'санаттар';
  ...
  @override
  String get edit_product_form_item_ingredients_title => 'Ингредиенттер';
  ...
  @override
  String get edit_product_form_item_add_valid_item_tooltip => 'Қосу';
  ...
  @override
  String get category_picker_page_appbar_text => 'Санаттар';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Қауымдастыққа AI шығарған бағаларды тексеруге рұқсат беріңіз.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'Файлдарды таңдау';

  @override
  String get prices_bulk_proof_upload_step_starting => 'Жүктеп салуды бастау';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return '#$index/$countфайлын жергілікті көшіру';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Жүктеп салу дайындалуда #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return '#$index/$countсуретте орындалмады';
  }
  ...
  @override
  String get prices_category_enter => 'Штрихкоды жоқ зат';

  @override
  String get prices_per_kilogram => 'Бір килограмм бағасы';
  ...
  @override
  String get prices_per_unit_short => ' / бірлік';

  @override
  String get prices_category_mandatory => 'Mandatory';

  @override
  String get prices_category_optional => 'Қосымша';

  @override
  String get prices_category_error_mandatory => 'Санат міндетті болып табылады';
  ...
  @override
  String get prices_list_title => 'Бағалар тізімі';
  ...
  @override
  String get prices_entry_shop_not_found => 'Белгісіз дүкен';

  @override
  String prices_entry_menu_title(String user) {
    return 'Баға жазбасы \"$user\"';
  }
  ...
  @override
  String get prices_entry_menu_open_proof => 'Дәлелдеуді көру';

  @override
  String get prices_entry_menu_my_prices => 'Менің басқа бағаларымды қараңыз';

  @override
  String get prices_entry_menu_author_prices =>
      'Автордың басқа бағаларын қараңыз';

  @override
  String get prices_entry_menu_shop_prices =>
      'Дүкеннен басқа бағаларды қараңыз';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Бағасы бұрын қосылған';
  ...
  @override
  String get dev_mode_section_data => 'Деректер';
  ...
  String user_any_search_prices_title(String user) {
    return 'Салымшылардың бағасы: $user';
  }
  ...
  @override
  String get category_picker_screen_title => 'Санаттар';
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Әдепкі тілді өзгерту керек пе?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Өнімнің әдепкі тілінің \"$language\" күйіне орнатылғанын қалайсыз ба?';
  }
  ...
  @override
  String get capture_new_picture => 'Суретке түсіру';
  ...
  @override
  String get action_delete_list => 'Жою';
  ...
  @override
  String get guide_share_label => 'Бөлісу';
...
<<<<<<< HEAD
  ...
  String get guide_greenscore_what_is_greenscore_title =>
      'Жасыл ұпай дегеніміз не?';

  @override
  String get guide_greenscore_what_is_greenscore_paragraph1 =>
      'Green-Score - бұл **тағамның қоршаған ортаға әсері** туралы хабарлауға бағытталған логотип.';

  @override
  String get guide_greenscore_what_is_greenscore_paragraph2 =>
      'Түс коды **ең аз әсер ететін** өнімдер үшін қою жасылдан (**A+**) **ең әсерлі** өнімдер үшін қою қызылға (**F**) дейін өзгереді.';

  @override
  String get guide_greenscore_logos_caption => 'Green-Score логотиптері';

  @override
  String get guide_greenscore_lca_title =>
      'Негізгі: Өмірлік циклді бағалау (LCA)';

  @override
  String get guide_greenscore_lca_arg1_title =>
      'Азық-түлік категорияларына ғылыми баға беру';

  @override
  String get guide_greenscore_lca_arg1_text1 =>
      'Әрбір өнім санаты үшін Agribalyse экологиялық дерекқорының деректері (ADEME және INRAE әзірлеген) арқылы **бенчмарк** ұпайы белгіленеді.';

  @override
  String get guide_greenscore_lca_arg1_text2 =>
      '**Өмірлік циклді талдау** – көп сатылы және көп критериалды экологиялық бағалауды жүргізуге арналған стандартталған бағалау әдісі.';

  @override
  String get guide_greenscore_lca_arg1_text3 => '**Өлшемдері:**';

  @override
  String get guide_greenscore_lca_arg2_title => '6 өндірістік қадам';
  ...
  @override
  String get guide_greenscore_lca_arg2_packaging => 'Қаптама';
  ...
  String get guide_greenscore_lca_arg3_title =>
      '14 қоршаған ортаға әсер ету көрсеткіштері';

  @override
  String get guide_greenscore_lca_arg3_text1 =>
      'Климаттың өзгеруі/көміртек ізі';

  @override
  String get guide_greenscore_lca_arg3_text2 => 'Озон қабатының бұзылуы';

  @override
  String get guide_greenscore_lca_arg3_text3 => 'Иондаушы сәулелену';

  @override
  String get guide_greenscore_lca_arg3_text4 => 'Жер';

  @override
  String get guide_greenscore_lca_arg3_text5 => 'Су және энергияны пайдалану';

  @override
  String get guide_greenscore_lca_arg3_text6 => 'Ауаның ластануы';

  @override
  String get guide_greenscore_lca_arg3_text7 =>
      'Теңіз және тұщы су (бөлшектер, қышқылдану, эвтрофикация)';

  @override
  String get guide_greenscore_lca_arg3_text8 => 'Ресурстардың сарқылуы.';

  @override
  String get guide_greenscore_bonuses_penalties_title =>
      'Бонустар мен айыппұлдар';

  @override
  String get guide_greenscore_bonuses_penalties_intro =>
      'Санаттағы жақсырақ өнімдерді марапаттау үшін біз бірнеше критерийге негізделген бонустар мен айыппұлдарды қолданамыз:';
  ...
  String get guide_greenscore_bonuses_penalties_arg2_text =>
      'Ингредиенттердің шығу тегі негізінде бонус беріледі. Бұл бонус тасымалдауға әсер етуді, сондай-ақ әрбір өндіруші елінің экологиялық саясатын ескереді.';
  ...
  @override
  String get guide_greenscore_bonuses_penalties_arg4_title => 'Қаптама';
  ...
  String get guide_greenscore_transparency_intro1 =>
      'Жасыл баллды дәл есептеу үшін қаптамада міндетті түрде көрсетілмеген (мысалы, әрбір ингредиенттің шығу тегі және нақты пайызы) немесе қолдануға жарамды түрінде сирек болатын ақпарат (мысалы, қолданылатын пластмассалардың нақты түрлерімен қаптаманың барлық компоненттерінің тізімі) болуы қажет.';

  @override
  String get guide_greenscore_transparency_intro2 =>
      'Орташа мәндер бұл ақпарат әлі қол жетімді болмаған кезде пайдаланылады, бірақ біз қазір барлығын осы ақпаратты жинауға көмектесуге шақырамыз, бұл Жасыл ұпай үшін өте пайдалы болады, сонымен қатар басқа да көптеген пайдаланулар үшін.';

  @override
  String get guide_greenscore_transparency_arg1_title =>
      'Қалай азаматтар көмектесе алады';

  @override
  String get guide_greenscore_transparency_arg1_text =>
      'Барлық азаматтар бізге өнімдерде бар немесе олардан шығарылатын ақпаратты жинауға және құрылымдауға көмектесе алады, мысалы, орау туралы ақпарат: Mission Emballages: барлық азық-түлік өнімдеріне арналған орауыштардың кең ауқымды бірлескен түгендеуі (француз тілінде)';

  @override
  String get guide_greenscore_transparency_arg2_title =>
      'Өндірушілер қалай көмектесе алады';

  @override
  String get guide_greenscore_transparency_arg2_text =>
      'Өндірушілер бізге өз ақпаратын өндірушілерге арналған тегін платформамыз арқылы тікелей жібере алады.';
...
>>>>>>> 33fe57b5c (Primer commit)
  ...
  @override
  String get knowledge_panel_warning_text => 'Ескерту';
  ...
  @override
  String get product_page_tab_for_me => 'Мен үшін';
  ...
  @override
  String get product_edit_robotoff_positive_button => 'Ұсынысты қабылдаңыз';

  @override
  String get product_edit_robotoff_negative_button => 'Ұсынысты қабылдамау';

  @override
  String get product_edit_robotoff_show_proof => 'Дәлелдеуді көрсетіңіз';

  @override
  String get product_edit_robotoff_expand_proof => 'Дәлелдеуді кеңейту';

  @override
  String get product_page_tab_raw_data => 'Шикі деректер';

  @override
  String page_indicator_with_total(int current, int total) {
    return '$current / $totalбет';
  }
  ...
  String item_count_with_total(int count, int total) {
    return '$total элементтердің $count';
  }
  ...
  @override
  String get prices_no_result => 'Ешқандай баға статистикасы табылмады.';

  @override
  String get prices_error_loading_more_items =>
      'Қосымша элементтерді жүктеу қатесі';
