...
class AppLocalizationsMt extends AppLocalizations {
  ...
  @override
  String get product_search_same_category => 'Sib alternattivi';
  ...
  @override
  String get edit_product_form_item_deny_suggestion => 'Ċaħda s-suġġeriment';
  ...
  String get prices_bulk_proof_upload_community_switch =>
      'Ħalli lill-komunità tivvalida l-prezzijiet estratti mill-AI.';
  ...
  @override
  String get prices_bulk_proof_upload_step_selecting => 'L-għażla tal-fajls';

  @override
  String get prices_bulk_proof_upload_step_starting => 'Nibdew it-tlugħ';

  @override
  String prices_bulk_proof_upload_step_copying(int index, int count) {
    return 'Ikkupjar lokalment tal-fajl #$index/$count';
  }

  @override
  String prices_bulk_proof_upload_step_preparing(int index, int count) {
    return 'Qed nippreparaw it-tlugħ #$index/${count}Qed nippreparaw it-tlugħ #$index / $count';
  }

  @override
  String prices_bulk_proof_upload_step_error(int index, int count) {
    return 'Falla fl-immaġni #$index/$count';
  }
  ...
  @override
  String get prices_category_enter => 'Oġġett mingħajr barcode';

  @override
  String get prices_per_kilogram => 'Prezz għal kull kilogramma';
  ...
  @override
  String get prices_category_optional => 'Mhux obbligatorju';

  @override
  String get prices_category_error_mandatory =>
      'Il-kategorija hija obbligatorja';
  ...
  @override
  String get prices_list_title => 'Lista tal-prezzijiet';

  @override
  String get prices_list_count => 'Numru ta\' prezzijiet\n';
  ...
  String prices_entry_menu_title(String user) {
    return 'Dħul tal-prezz minn \"$user\"';
  }
  ...
  @override
  String get prices_entry_menu_my_prices => 'Ara l-prezzijiet l-oħra tiegħi';

  @override
  String get prices_entry_menu_author_prices =>
      'Ara prezzijiet oħra mill-awtur';

  @override
  String get prices_entry_menu_shop_prices => 'Ara prezzijiet oħra mill-ħanut';
  ...
  @override
  String get prices_amount_existing_subtitle => 'Prezz miżjud qabel';
  ...
  String user_any_search_prices_title(String user) {
    return 'Prezzijiet tal-kontributuri: $user';
  }
  ...
  String get add_basic_details_product_name_change_main_language_title =>
      'Tibdel il-lingwa awtomatika?';

  @override
  String add_basic_details_product_name_change_main_language_text(
    String language,
  ) {
    return 'Trid li l-lingwa awtomatika tal-prodott tkun issettjata għal \'$language\'?';
  }
  ...
  @override
  String get product_page_tab_for_me => 'Għalija';
  ...
  @override
  String get product_edit_robotoff_negative_button => 'Irrifjuta s-suġġeriment';

  @override
  String get product_edit_robotoff_show_proof => 'Uri l-prova';

  @override
  String get product_edit_robotoff_expand_proof => 'Espandi l-prova';

  @override
  String get product_page_tab_raw_data => 'Dejta mhux ipproċessata';

  @override
  String page_indicator_with_total(int current, int total) {
    return 'Paġna $current / $total';
  }

  @override
  String page_indicator(int current) {
    return 'Paġna $current';
  }

  @override
  String item_count_with_total(int count, int total) {
    return '$count minn $total oġġetti';
  }
  ...
  @override
  String get prices_no_result => 'Ma nstabet l-ebda statistika tal-prezzijiet.';

  @override
  String get prices_error_loading_more_items =>
      'Żball fit-tagħbija ta\' aktar oġġetti';
